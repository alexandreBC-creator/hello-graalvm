...
* The original package name 'com.castilho-lib.hello-graalvm' is invalid and this project uses 'com.castilho_lib.hello_graalvm' instead.
...
```
$ docker run --rm -p 8080:8080 hello-graalvm:0.0.1-SNAPSHOT
```
